...
def remove_background(
    ...
    **rembg_kwargs,
    ...
    if do_remove:
        # NOTE (EchoForge patch): rembg is a heavy optional dependency (~170MB
        # U2-Net weights). Import it lazily so the rest of the pipeline works
        # without it — the backend does its own lightweight foreground prep.
